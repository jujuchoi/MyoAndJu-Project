...
<h3>답글쓰기</h3>
<form name="boardReplyWriteForm" id="boardReplyWriteForm">
	...
	<input type="hidden" name="pg" id="pg" value="${pg}">
		<table border="0" cellspacing="0" cellpadding="11">
			...
			<tr>
				...
				<input type="button" id="postReplyBtn" value="답글작성">
				<input type="reset" id="resetBtn" value="다시작성"></td>
			</tr>
		</table>
</form>
	<script
	...
	<script>
		$('#postReplyBtn').click(function() {
			...
			if ($('#subject').val() == '') {
				...
				$.ajax({
					type : 'post',
					url : '/miniProject2/board/boardReplyWrite.do',
					data : {
						'subject' : $('#subject').val(),
						'content' : $('#content').val(),
						'pseq': $('#pseq').val()
